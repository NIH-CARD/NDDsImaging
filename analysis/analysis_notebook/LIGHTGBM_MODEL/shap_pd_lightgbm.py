...
# cd /data/dadua2/project_MLPhenotypesMRIGWAS/figures4paper/shap_values
# singularity exec --nv --bind /data/dadua2 --workdir /data/dadua2/BaselineClassification docker://anantdadu/baselineclassification_xgb_gpu:1.0 /opt/miniconda3/envs/h2oai_env/bin/python -i shap_ad.py
...
joblib.dump(model, 'pd_full_lgb.pkl')
joblib.dump(reduced_model, 'pd_reduced_lgb.pkl')


gbm_pickle1 = joblib.load('pd_full_lgb.pkl')
gbm_pickle2 = joblib.load('pd_reduced_lgb.pkl')